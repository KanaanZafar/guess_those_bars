...
class OneByOneDraw extends StatefulWidget {
  int originalTimer;
  ...
  @override
  _OneByOneDrawState createState() => _OneByOneDrawState(
      originalTimer,
      currentQueNumber,
...
class _OneByOneDrawState extends State<OneByOneDraw> {
  int originalTimer;
  int currentQueNumber;
  bool permissionToRecordVideo;
  int player1Corrects;
...
//    _wheelNotifier.stream.listen((data) {
//      print('wheel data: ${data}');
//    });
  }
            ...
            children: <Widget>[
              ...
              Column(
                children: <Widget>[
                  Image.asset(
                    Constant.arrowAsset,
                    height: 35.0, width: 35.0, //fit: BoxFit.fill,
                  ),
                  spinner(),
                ],
              ),

...
class OneByOneResults extends StatefulWidget {
  int originalTimer;
  ...
  @override
  _OneByOneResultsState createState() => _OneByOneResultsState(
      originalTimer,
      currentQueNumber,
...
class _OneByOneResultsState extends State<OneByOneResults> {
  int originalTimer;
  int currentQueNumber;
  bool permissionToRecordVideo;
  int player1Corrects;
  ...
  void initState() {
    ...
    winner = player1Score > player2Score
        ? "Player 1"
        : player1Score == player2Score ? "Tie" : "Player 2";
...
//    }
  ...
  Widget build(BuildContext context) {
    ...
    double multiplyer = videoPath == '' ? 0.90 : 1.0;
    return SafeArea(
        child: Scaffold(
      key: scaffoldKey,
...
//              color: Colors.white,
  ...
  dealReplay() {
    Navigator.pushReplacement(
        context,
        MaterialPageRoute(
            builder: (ctx) => PlayOneByOne(originalTimer, 0,
                permissionToRecordVideo, currentQueNumber, quesList)));
  }

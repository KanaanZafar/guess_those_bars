...
class AnswersTeamByTeam extends StatefulWidget {
  Widget topRow;
  int player1Corrects;
  int player1Wrongs;
  int player2Corrects;
  ...
  @override
  _AnswersTeamByTeamState createState() => _AnswersTeamByTeamState(
      topRow,
      player1Corrects,
      player1Wrongs,
      player2Corrects,
...
class _AnswersTeamByTeamState extends State<AnswersTeamByTeam> {
  Widget topRow;
  int player1Corrects;
  int player1Wrongs;
  int player2Corrects;
  ...
  void initState() {
    ...
    super.initState();
//    player1Score = player1Corrects - player2Wrongs;
...
//        ));
  ...
  Widget playerCon(bool isBlue, int currentPlayer) {
    return GestureDetector(
      onTap: () {
        print(
            'player1: ${player1Corrects} and ${player1Wrongs} and ${player1Score}');
